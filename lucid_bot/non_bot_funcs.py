...
class NonBotFuncs():
    ...
    async def yes_no_dialogue(self, message_name: discord.Message, timeout: int, dm: bool, ctx) -> object:
    ...
    async def announcement_send(self, ctx, announce_channel, announce_embed, channel_tag):
        # CONFIRM/DENY SEND
