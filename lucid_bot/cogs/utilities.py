...
class Utilities(commands.Cog):
    ...
    async def help(self, ctx, *args): 
        ...
        if not args:
            ...
            embed.add_field(
                name="Moderation -",
                value="`kick`, `mute`, `ban`, `slowmode`, `lockdown`",
                inline=False,
            )
            ...
            embed = discord.Embed(
                ...
                color=hexInt,
                description="\n\n".join(self.config["commandList"]["utilities"]),
                inline=True,
            )
            ...
            embed = discord.Embed(
                ...
                color=hexInt,
                description="\n\n".join(self.config["commandList"]["general"]),
                inline=True,
            )
            ...
            embed = discord.Embed(
                ...
                color=hexInt,
                description="\n\n".join(self.config["commandList"]["moderation"]),
                inline=True,
            )
    ...
    async def buy(self, ctx):
        embed = discord.Embed(
            title="Lucid Applications -",
            description="All customers looking to purchase or be granted "
